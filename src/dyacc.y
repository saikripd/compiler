...
int rrCount=0;
%}
%token INT_LIT, FLOAT_LIT, CHAR_LIT, STRING_LIT, IDENTIFIER, WRITELN
...
%type <token> RETURN, SHORT, SIZEOF, STATIC, STRUCT, SUPER, SWITCH, THIS, THROW, TRUE, TRY, TYPEOF, UBYTE, UINT, ULONG, USHORT, VOID, WHILE, WRITELN
...
%type <node> VarDeclarationList, VarDeclarationsList
...
%type <node> CaseStatementDummy, SwitchStatement, SwitchDummy, PrintStatement
                                                                ...
                                                                { 
                                                                    ...
                                                                    if(entries1 != NULL)
                                                                    {
                                                                        ...
                                                                        while(next != NULL)
                                                                        {
                                                                            ...
                                                                            strcpy(c1,strcat(strcat($$->structureName, "."), next->id));
...
// change type to type1 as we are not returning arrays
        Type IDENTIFIER '(' FuncScopeDummy VarDeclarationList ')' FunctionBody              {
                                                                                                ...
                                                                                                if(findSymbol($2.text, stack_head, 0) == NULL)
                                                                                                {
                                                                                                    ...
                                                                                                    $$->symbolEntry->tx=++globaltx;
                                                                                                    $$->symbolEntry->child = funcSymbolTable;
                                                                                                    funcSymbolTable->parent = $$->symbolEntry;
                                                                                                    if($7->codeStart != NULL)
                                                                                                    {
                                                                                                        $$->symbolEntry->codeStart = $7->codeStart;
                                                                                                        $$->codeStart = $7->codeStart;
                                                                                                        $$->codeEnd = $7->codeEnd;
                                                                                                        $$->codeStart->functionEntry = $$->symbolEntry;
                                                                                                    }
                                                                                                    else
                                                                                                        printf("Function %s has no body code", $2.text);
...
//                                                                                                     $$->currentTable = $5->currentTable;
                                                                                                    ...
                                                                                                    if($8->codeStart != NULL)
                                                                                                    {
                                                                                                        ...
                                                                                                        printf("Function %s has no body code", $3.text);
                                                                                                    globalStructs[struct_head]->type=FUNCTION;
...
//                                                   Check that the variable is a function and the number of arguments accepted are also same and also in the same form
    ...
    |   IDENTIFIER '.' MainExpression           {
                                                    ...
                                                    char *c1;
                                                    c1 = (char*)malloc(50*sizeof(char));
                                                    strcpy(c1,strcat(strcat($1.text, "."), $3->lexeme));
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        $$->tx = id->tx;
                                                        strcpy($$->lexeme, strcat(strcat($1.text, "."), $3->lexeme));
                                                    }
...
IfStatement     :
        IF '(' Expression ')' IfScopeDummy1 BlockStatement              {
                                                                            ...
                                                                            if($6->codeStart != NULL && ($3->basetype == BOOL || implicitCompatible($3->basetype, INT)))
                                                                            {
                                                                                ...
                                                                                $6->codeEnd->next = nop;
                                                                                $$->codeEnd = nop;
                                                                                $6->symbolEntry = addSymbol($6, "then-block", top(0));
                                                                                $6->symbolEntry->child = blocSymbolTable;
                                                                                blocSymbolTable->parent = $6->symbolEntry;
                                                                            }
                                                                        }
    |   IF '(' Expression ')' IfScopeDummy1 BlockStatement IfEndScopeDummy ELSE IfScopeDummy2 BlockStatement    {
                                                                                        ...
                                                                                        if($6->codeStart != NULL || $10->codeStart != NULL && ($3->basetype == BOOL || implicitCompatible($3->basetype, INT)))
                                                                                        {
                                                                                            ...
                                                                                            $$->codeEnd = nop;
                                                                                            $10->symbolEntry = addSymbol($10, "else-block", top(0));
                                                                                            $10->symbolEntry->child = blocSymbolTable;
                                                                                            blocSymbolTable->parent = $10->symbolEntry;
                                                                                        }
         ;                                                                           }
IfEndScopeDummy : 
                                                                               {
                                                                                ...
                                                                                $$ = createNode(0);
                                                                                strcpy($$->lexeme, "if then block end");
                                                                                  symbolTable *blocSymbolTable = pop();
                                                                                  $$->symbolEntry = addSymbol($$, "then-block", top(0));
                                                                                  $$->symbolEntry->child = blocSymbolTable;
                                                                                  blocSymbolTable->parent = $$->symbolEntry;
                                                                               }
    ;
WhileStatement  :
...
//                                                                             $$->children[2]->parent = $$;
                                                                            ...
                                                                            if($6->codeStart != NULL && ($4->basetype == BOOL || implicitCompatible($4->basetype, INT)))
                                                                            {
                                                                                ...
                                                                                $$->codeEnd = $3->codeStart;
                                                                                            $6->symbolEntry = addSymbol($6, "while-block", top(0));
                                                                                            $6->symbolEntry->child = blocSymbolTable;
                                                                                            blocSymbolTable->parent = $6->symbolEntry;
                                                                            }
                                                                        }
...
//                                                                             $$->children[2]->parent = $$;
                                                                            ...
                                                                            if($3->codeStart != NULL && ($6->basetype == BOOL || implicitCompatible($6->basetype, INT)))
                                                                            {
                                                                                ...
                                                                                $$->codeEnd = $2->codeStart;
                                                                                            $3->symbolEntry = addSymbol($3, "do-while-block", top(0));
                                                                                            $3->symbolEntry->child = blocSymbolTable;
                                                                                            blocSymbolTable->parent = $3->symbolEntry;
                                                                            }
                                                                        }
    ;
...
//                                                                             $$->children[2]->parent = $$;
                                                                            ...
                                                                            if($7->codeStart != NULL && ($5->basetype == BOOL || implicitCompatible($5->basetype, INT)))
                                                                            {
                                                                                ...
                                                                                $$->codeEnd = $3->codeStart;
                                                                                            $7->symbolEntry = addSymbol($7, "else-block", top(0));
                                                                                            $7->symbolEntry->child = blocSymbolTable;
                                                                                            blocSymbolTable->parent = $7->symbolEntry;
...
//                                                                             $$->children[2]->parent = $$;
                                                                            ...
                                                                            if($8->codeStart != NULL && ($5->basetype == BOOL || implicitCompatible($5->basetype, INT)))
                                                                            {
                                                                                ...
                                                                                gotoexp2->next =  $3->codeStart;
                                                                                $$->codeEnd =  $3->codeStart;
                                                                                            $8->symbolEntry = addSymbol($8, "for-block", top(0));
                                                                                            $8->symbolEntry->child = blocSymbolTable;
                                                                                            blocSymbolTable->parent = $8->symbolEntry;
...
CaseStatement:
    CASE Starting ':' CaseStatementDummy StatementListNoCaseNoDefault   {
                                                                            ...
                                                                            $$->thisCase->codeStart = $$->statementsASTnode->codeStart;
                                                                            $$->statementsASTnode->symbolEntry = addSymbol($$->statementsASTnode, "case", top(0));
                                                                            $$->statementsASTnode->symbolEntry->child = blocSymbolTable;
                                                                            blocSymbolTable->parent = $$->statementsASTnode->symbolEntry;
                                                                        }
;
DefaultStatement:
        DEFAULT ':' CaseStatementDummy StatementListNoCaseNoDefault {
                                                                            ...
                                                                            $$->thisCase->codeStart = $$->statementsASTnode->codeStart;
                                                                            $$->statementsASTnode->symbolEntry = addSymbol($$->statementsASTnode, "default", top(0));
                                                                            $$->statementsASTnode->symbolEntry->child = blocSymbolTable;
                                                                            blocSymbolTable->parent = $$->statementsASTnode->symbolEntry;
                                                                        }
;
